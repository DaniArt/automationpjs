...
def JuniorRegisterCKC_AllDataSet():
    ...
    for row in data_list:  
        if row['ITER_CODE'] == '1':
            name_file = f'{Ndeacrd.GetRandomNumber()}_JuniorRegisterCKC.json'  
            JuniorRegisterCKC(row['DOC_CODE'],name_file)
            
def JuniorRegisterCKC(DOC_CODE,name_file):
