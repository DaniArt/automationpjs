...
def ReAcceptRefusalCrd(idn_card, name_file):
    ...
    value = ["Отмена от отказа в акцептовании карты для возврата на акцепт", f"Отмена от отказа в акцептовании карты {idn_card} для возврата на акцепт", NCRD.GetDateTimeMilli()]
