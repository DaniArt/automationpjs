...
def CreateDogovorCKC_AllDataSet():
    ...
    for row in data_list:
        try:
            if row['ITER_CODE'] == '1':
                name_file = f'{Ndeacrd.GetRandomNumber()}_CreateDogovorCKC.json'   
                form_data = CreateDogovorCKC(row['DEPO_CODE'],row['VAL_CODE'],
...
def CreateDogovorCKC(depo_code,val_code,cli_id,tarif_code,ckc_code,name_file):
